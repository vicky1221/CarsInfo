...
//    activityIndicator.center = self.center;
    ...
    activityIndicator.frame = CGRectMake((self.bounds.size.width - activityIndicator.bounds.size.width)/2, (self.bounds.size.height - activityIndicator.bounds.size.height)/2, 34, 34);
