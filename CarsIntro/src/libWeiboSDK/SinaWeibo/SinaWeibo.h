...
@interface SinaWeibo : NSObject <SinaWeiboAuthorizeViewDelegate, SinaWeiboRequestDelegate>
{
    ...
    id<SinaWeiboDelegate, SinaWeiboRequestDelegate> delegate;
...
@property (nonatomic, assign) id<SinaWeiboDelegate, SinaWeiboRequestDelegate> delegate;
...
// Send a Weibo, to which you can attach an image url.
