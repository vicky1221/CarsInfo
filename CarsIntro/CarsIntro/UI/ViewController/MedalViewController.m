...
-(void)senderAPI
{
    [[WebRequest instance] requestWithCatagory:@"get" MothodName:[NSString stringWithFormat:@"c=channel&a=type_json&tid=40&uid==%@", [DataCenter shareInstance].accont.loginUserID] andArgs:nil delegate:self andTag:560];
}
